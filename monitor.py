...
COMPANIES = [
    ...
    ("Notion",      lambda: greenhouse("notion")),
    ...
    ("DoorDash",    lambda: greenhouse("doordash")),
    ("Datadog",     lambda: greenhouse("datadog")),
    ("Snowflake",   lambda: greenhouse("snowflake")),
    ("Palantir",    lambda: greenhouse("palantir")),
    ...
    ("Plaid",       lambda: greenhouse("plaid")),
    ("Brex",        lambda: greenhouse("brex")),
    ("Rippling",    lambda: greenhouse("rippling")),
    ("Uber",        lambda: lever("uber")),
    ("Pinterest",   lambda: lever("pinterest")),
    ("Instacart",   lambda: lever("instacart")),
    ("Spotify",     lambda: lever("spotify")),
    ("Grammarly",   lambda: lever("grammarly")),
    ("Chime",       lambda: lever("chime")),
]
